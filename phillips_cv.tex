...
\rhead{\textsc{Zack Phillips ~    \thepage{} of \pageref*{LastPage}}} \cfoot{}
\thispagestyle{empty}
...
\emph{Ph.D., \href{http://ast.coe.berkeley.edu/}{Applied Science and Technology}} \rdate{2014 - 2019}
\begin{itemize}
...
\begin{itemize}
  \item Thesis: \href{https://github.com/zfphil/masters/blob/main/Phillips_mastersThesis.pdf}{Coded Illumination Techniques for Phase Imaging and Motion Blur}
  \item Research Advisor: \href{http://www.laurawaller.com}{Laura Waller}
...
\begin{itemize*}
  \item Senior Thesis: $\mu$Culture: A portable micro-incubator for cellular motility studies (...)
...
\textbf{Advanced Imaging Methods Group, \textbf{Insitro}} ~|~ South San Francisco, CA \newline
\emph{Senior ML Optical Engineer}  \rdate{{November~2021 - Present}}
% \begin{itemize*}
%   \item Project lead for interdisciplinary R\&D effort within Biophotonics group
%   \item Technical responsibilities span optical and mechanical design, automation, and simulation 
%   \item Delivered monthly progress updates to Apple executive and team
% \end{itemize*}

\textbf{Exploratory Design Group (XDG), \textbf{Apple}} ~|~ Cupertino, CA \newline
\emph{Optical Engineer}  \rdate{{July~2019 - October 2021}}
\begin{itemize*}
  \item Project lead for interdisciplinary R\&D effort within Biophotonics group
  \item Technical responsibilities span optical and mechanical design, automation, and simulation 
  \item Delivered monthly progress updates to Apple executive and team
...
\smallskip
\textbf{Waller Lab, University of California, Berkeley} ~|~  Berkeley, CA \newline
\emph{Graduate Student Researcher (\href{http://www.laurawaller.com}{PI: Laura Waller})} \rdate{{July}~2014 - {May}~2019}
\begin{itemize*}
  \item Developed methods for phase retrieval, super-resolution, and high-throughput optical microscopy
  \item Cultivated duel expertise in GPU computation (inverse problems) and optical hardware
  \item Mentored 11 undergraduates for summer and semester projects
\end{itemize*}

\smallskip
\textbf{SCI Microscopy} ~|~ Berkeley, CA \newline
\emph{CEO and Co-founder (with Laura Waller) - \href{http://sci-microscopy.com}{website}}\rdate{{Jan~2017 - Present}}
\begin{itemize*}
  \item Spin-off company focused on developing LED arrays for computational microscopy
  \item Designed and delivered over 30 LED arrays to customers across 6 countries
\end{itemize*}
...
\begin{itemize*}
	\item Staff R\&D engineer and optomechanical designer for AWARE 40 (2.3 Gigapixel) camera
...
\smallskip
\mhead{Tools and \newline Expertise}
\hspace{-0.005\textwidth}Python (various contexts), CAD (\href{https://www.plm.automation.siemens.com/global/en/products/nx/}{NX}~/~\href{https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjmjfiR6MrwAhWI9uMHHWk2C1EYABAAGgJ5bQ&ae=2&ohost=www.google.com&cid=CAESQeD2LY0X5l4p2HBdFeLnP93VOoKY_Ec01eRXtc12rKZl44vm962KuoKk1LEftKuGJZ0GEwt_7XyS7lcy9ynqNbZv&sig=AOD64_2ZTJzu01bEPQUF4FiWoLmmgt_Ihw&q&adurl&ved=2ahUKEwjsv-yR6MrwAhXLqp4KHbtgDtUQ0Qx6BAgEEAE&dct=1}{Fusion360}~/~\href{https://www.solidworks.com}{SolidWorks}), Machining and 3D printing,
\\ \qquad\qquad\qquad\qquad PCB Design (\href{https://www.kicad.org}{KiCad}), \href{https://www.mathworks.com/products/matlab.html}{MATLAB}, \href{https://photonengr.com/fred-software/}{FRED Optical Design}, \href{https://www.apple.com/keynote/}{Keynote}~/~\href{https://slides.com/}{slides.com}, Vendor Engagement


\smallskip
\mhead{Awards and \newline Affiliations}%
\textbf{AS\&T Excellence in Research Award} ~|~  UC Berkeley \rdate{2019}\\
\textbf{Founding Member} ~|~ Baker Innovation Fellows (UC Berkeley) \rdate{2017 - 2018} \\ 
