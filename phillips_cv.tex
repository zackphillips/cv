...
\mhead{}Full-stack optical sensing engineer and manager, currently a core architect of insitro's ML-enabled drug discovered platform. Ex-Apple R\&D Engineer, XDG. Deep-tech microscopy start-up Co-founder.
...
\textbf{Computational Microscopy Group, \textbf{insitro}} ~|~ South San Francisco, California \newline
\emph{Associate Director, Computational Microscopy}  \rdate{{September~2023 - Present}} \newline
...
\begin{itemize*}
  \item Platform architect and full-stack engineer of insitro's ML-enabled drug discovery platform
\end{itemize*}
...
\textbf{University of California, Berkeley} ~|~ Berkeley, California  \newline
\emph{M.S., \href{http://ast.coe.berkeley.edu/}{Applied Science and Technology}}. GPA 3.6 \rdate{June~2014 - December~2016}
\begin{itemize}
...
\emph{B.S. with Highest Honors, \href{https://www.bme.unc.edu/}{Applied Science and Engineering}}. GPA 3.7 \rdate{August~2009 - May~2013}
\begin{itemize*}
...
\smallskip
\mhead{Tools and \newline Expertise}
\hspace{-0.005\textwidth}Team-Building and Leadership, Computational Imaging, Python (Development and Technical Leadership), Optical Engineering, Vendor Management, CAD (\href{https://www.plm.automation.siemens.com/global/en/products/nx/}{NX}~/~\href{https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjmjfiR6MrwAhWI9uMHHWk2C1EYABAAGgJ5bQ&ae=2&ohost=www.google.com&cid=CAESQeD2LY0X5l4p2HBdFeLnP93VOoKY_Ec01eRXtc12rKZl44vm962KuoKk1LEftKuGJZ0GEwt_7XyS7lcy9ynqNbZv&sig=AOD64_2ZTJzu01bEPQUF4FiWoLmmgt_Ihw&q&adurl&ved=2ahUKEwjsv-yR6MrwAhXLqp4KHbtgDtUQ0Qx6BAgEEAE&dct=1}{Fusion360}~/~\href{https://www.solidworks.com}{SolidWorks}), Design for Manufacture,
PCB Design (\href{https://www.kicad.org}{KiCad}), \href{https://www.mathworks.com/products/matlab.html}{MATLAB}, \href{https://photonengr.com/fred-software/}{FRED Optical Design}
