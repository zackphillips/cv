...
\textbf{Advanced Imaging Methods Group, \textbf{Insitro}} ~|~ South San Francisco, California \newline
\emph{Assiciate Director, Microscopy Systems}  \rdate{{September~2023 - Present}}

\emph{Staff Automation Engineer, Microscopy}  \rdate{{March~2023 - August 2023}}

\emph{Senior ML Optical Engineer}  \rdate{{November~2021 - March 2023}}

\begin{itemize*}
  \item Led Advanced Imaging Modalities group; ML-enabled microscopy for drug discovery
  \item Member of imaging platform, responsible for developing and scaling microscopy platform
\end{itemize*}
...
\begin{itemize*}
  ...
  \item Delivered monthly progress updates to Apple Fellow (VP) and team
\end{itemize*}
...
\textbf{Qinf PhD Fellowship Recipient}~|~ Qualcomm inc.                  \rdate{2016 - 2017}\\
