...
\mhead{}Full-stack computational sensing engineer with experience prototyping and scaling fit-for-purpose data creation pipelines suitable for ML. Former member of Apple's Exploratory Design Group (XDG).
...
\emph{Senior Manager, Computational Microscopy}  \rdate{{September~2023 - Present}} \newline
...
\begin{itemize*}
  \item Core-team member and full-stack engineer of insitro's ML-enabled drug discovery platform
\end{itemize*}
