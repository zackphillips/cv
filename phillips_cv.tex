...
\def\myauthor{Zack Phillips}
\def\mytitle{pdg-vita}
\def\myemail{zack@zackphillips.com}
\def\myweb{https://www.ocf.berkeley.edu/~zfphil/}
\def\mygithub{https://github.com/zackphillips}
...
\rhead{\textsc{Zack Phillips, PhD ~    \thepage{} of \pageref*{LastPage}}} \cfoot{}
\thispagestyle{empty}
\begin{adjustwidth}{-1in}{}
  \vspace*{-1cm}
{\Huge
  {\textsc{Zack Phillips, PhD}}
}
\hfill\hfill\hfill
{
...
\mhead{}Full-stack computational sensing engineer with deep expertise in computational imaging algorithms, hardware/software co-design, and high-throughput optical microscopy. Experienced building novel imaging systems from physical optics through algorithm development to production-scale software pipelines. Former member of Apple's Exploratory Design Group (XDG) and the Waller Lab at UC Berkeley.
...
\textbf{Cellular Machine Learning Platform, \textbf{insitro}} ~|~ South San Francisco, California \newline
\emph{Director of Imaging, Cellular Machine Learning}  \rdate{{September~2025 - Present}} \newline
\emph{Senior Manager, Computational Microscopy}  \rdate{{September~2023 - August~2025}} \newline
\emph{Staff Automation Engineer, Microscopy}  \rdate{{March~2023 - September~2023}} \newline
\emph{Senior Machine Learning Optical Engineer}  \rdate{{November~2021 - March~2023}}

\begin{itemize*}
  \item Designed and built insitro's ML-enabled imaging platform end-to-end: optical hardware, control software, image processing algorithms, and data pipelines for high-throughput drug discovery
  \item Developed computational imaging methods for Cell Painting and pooled CRISPR screens; contributed to platform enabling self-supervised deep learning for de novo gene function inference (Nat.~Commun.~2026)
  \item Architected scalable image acquisition and QC systems processing millions of microscopy images per week across multiple instruments
\end{itemize*}

\textbf{Exploratory Design Group (XDG), \textbf{Apple}} ~|~ Cupertino, California \newline
\emph{Photonics Engineer}  \rdate{{July~2019 - October~2021}}
\begin{itemize*}
  \item Full-stack computational sensing engineer in Biophotonics R\&D: designed novel optical sensing systems spanning physical optics, signal processing algorithms, and embedded software integration
  \item Drove prototype-to-pilot development of undisclosed sensing modality within Apple's Exploratory Design Group
\end{itemize*}
...
\begin{itemize*}
  \item Developed computational microscopy algorithms including quantitative phase imaging (DPC, cDPC), Fourier ptychography, motion deblurring, and LED-array illumination design
  \item Published 8+ peer-reviewed papers on coded illumination techniques; PhD dissertation: \href{https://escholarship.org/uc/item/70d9j190}{\emph{Quantitative Microscopy Using Coded Illumination}}
\end{itemize*}
...
\begin{itemize*}
  \item R\&D engineer for AWARE Gigapixel camera; contributed to computational optics design, characterization, and system integration for a multi-gigapixel wide-FOV imaging system
...
\textbf{University of California, Berkeley} ~|~ Berkeley, California  \newline
\emph{M.S., \href{http://ast.coe.berkeley.edu/}{Applied Science and Technology}}. GPA 3.57 \rdate{June~2014 - December~2016}
\begin{itemize}
  \item Masters Thesis: \href{https://github.com/zfphil/masters/blob/main/Phillips_mastersThesis.pdf}{Coded Illumination Techniques for Phase Imaging and Motion Blur}
  \item Research Advisor: \href{http://www.laurawaller.com}{Laura Waller}

\end{itemize}

\textbf{University of North Carolina, Chapel Hill} ~|~ Chapel Hill, North Carolina  \newline
\emph{B.S. with Highest Honors, \href{https://www.bme.unc.edu/}{Applied Science and Engineering}}. GPA 3.33 \rdate{August~2009 - May~2013}
\begin{itemize*}
  \item Undergraduate Thesis: \href{https://catalog.lib.unc.edu/catalog/UNCb11559302}{Designing and building a micro-incubator for cellular motility studies}
...
\smallskip
\mhead{Tools and \newline Expertise}
\hspace{-0.005\textwidth}\textbf{Computational Imaging:} quantitative phase imaging, Fourier ptychography, DPC/cDPC, fluorescence microscopy, OCT, motion deblurring, illumination design, optical system modeling\\
\textbf{Software:} Python (NumPy, SciPy, PyTorch, scikit-image), MATLAB, C++, embedded systems\\
\textbf{Systems:} hardware/software co-design, high-throughput imaging pipelines, hardware prototyping, optical engineering

\smallskip
\mhead{Awards and \newline Affiliations}%
\textbf{AS\&T Excellence in Research Award} ~|~  UC Berkeley \rdate{2019}\\
\textbf{Qinf PhD Fellowship Recipient}~|~ Qualcomm inc.                  \rdate{2016}\\
\textbf{Eagle Scout} ~|~  Boy Scouts of America         			         \rdate{2008} \\

\begin{center}\textit{References available upon request - please email \href{mailto:zack@zackphillips.com}{zack@zackphillips.com}}\end{center}
...
\medskip
Sivanandan, S., ... \textbf{Z.F. Phillips}, et al.~\date{19 \textsc{December} 2025}.~\emph{A Pooled Cell Painting CRISPR Screening Platform Enables de novo Inference of Gene Function by Self-supervised Deep Learning}. Nat Commun 17, 77 (2026). \href{https://doi.org/10.1038/s41467-025-66778-6}{(doi)}
...
\medskip
R. Eckert, \textbf{Z.F. Phillips}, and L. Waller.~(\date{1 \textsc{July} 2018}).
