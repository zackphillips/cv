...
\usepackage[margin=1.125in,top=1.375in,right=1in,left=1in]{geometry}
...
\begin{itemize*}
   ...
   \item Developed methods of robust segmentation for approximately 10,000 images
...
\begin{itemize*}
   \item Developed, assembled, and sold LED Array devices to collaborators and research groups
   \item Consulted for patents related to work done at UC Berkeley
\end{itemize*}
...
\medskip
\mhead{Activities \& \newline Interests}%
UC Berkeley SEED Elementary School Outreach \rdate{2015-} \\ UNC WaterSki Club Team \rdate{2010-2012}  \\
UNC Underwater Hockey Club \rdate{2009-2013}
...
\medskip
\textbf{Z.F. Phillips}, M.V. D'Ambrosio, L. Tian, J. Rulison, H.S. Patel, N. Sadras, A. Gande, N. Switz, D.A. Fletcher and L. Waller~(\date{13 \textsc{May} 2015}).
...
\emph{Multi-Frame Motion Imaging For Optical Microscopy} Focus on Microscopy 2018.
\medskip
